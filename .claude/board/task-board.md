...
|----|------|-------|--------|-----------|------|----------|
| D3-T01 | 总体架构设计与模块划分 | agent-lead | P0 | — | 2h | 架构图+模块描述+技术选型确认 |
| D3-T02 | 算法模块设计（含数据管道） | agent-algorithm | P0 | — | 2h | SUMO配置方案+模型架构+数据管道设计 |
| D3-T03 | 前端架构与路由设计 | agent-frontend-main | P0 | — | 1.5h | 路由表+组件树+状态管理方案 |
