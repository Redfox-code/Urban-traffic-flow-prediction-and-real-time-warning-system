...
|----|------|-------|--------|-----------|------|----------|
| D3-T04 | 地图集成方案设计 | agent-frontend-map | P0 | — | 1.5h | 高德API接入方案+WebSocket事件设计 |
| D3-T05 | 数据库设计与E-R图 | agent-test-docs | P0 | ~~D3-T01~~ ✅ | 2h | E-R图+数据字典+DDL脚本草案 |
...
|----|------|-------|---------|---------|
| D3-T03 | 前端架构与路由设计 | agent-frontend-main | 2026-07-01 | 1.5h |
