...
|----|------|-------|---------|--------|
| D3-T01 | 总体架构设计与模块划分 | agent-lead | 2026-07-01 | [总体架构设计-20260701.md](../docs/02-概要设计/总体架构设计与模块划分-20260701.md) |
| D3-T02 | 算法模块设计（含数据管道） | agent-algorithm | 2026-07-01 | [算法模块设计-20260701.md](../docs/02-概要设计/算法模块设计-20260701.md) |
| D3-T04 | 地图集成方案设计 | agent-frontend-map | 2026-07-01 | [地图集成方案设计-20260701.md](../docs/02-概要设计/地图集成方案设计-20260701.md) |
| D3-T05 | 数据库设计与E-R图 | agent-test-docs | 2026-07-01 | [数据库设计与E-R图-20260701.md](../docs/02-概要设计/数据库设计与E-R图-20260701.md) |
| D3-T03 | 前端架构与路由设计 | agent-frontend-main | 2026-07-01 | [前端架构与路由设计-20260701.md](../docs/02-概要设计/前端架构与路由设计-20260701.md) |
