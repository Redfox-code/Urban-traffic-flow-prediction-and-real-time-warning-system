...
11. ⚠️ **每做一个技术决策（选型/参数/架构），立即追加到 decisions-log.md**：背景、选项、决议、理由。不等任务结束。
12. 如果是**站会主持**：
...
3. **.claude/board/decisions-log.md** — 每次技术决策（选型/架构/参数/算法）立即追加：背景、选项、决议、理由

> 如果任务完成了代码但没更新这三个文件，任务不算完成。
